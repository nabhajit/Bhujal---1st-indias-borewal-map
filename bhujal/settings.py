"""
Django settings for bhujal project.
...
ALLOWED_HOSTS = ['*', 'localhost', '127.0.0.1', '.vercel.app', 'www.bhujal.tech', 'bhujal.tech',]
...
# Enable automatic file compression and caching
...
LOGGING = {
    ...
    'loggers': {
        'django': {
            'handlers': ['console'],
            'level': 'ERROR',  # You can set it to 'DEBUG' temporarily for more information
        },
    },
}
